      ...
      <Grid condensed narrow fullWidth className="mt-3">
        ...
        <Column sm={4} md={3} lg={4}>
          ...
          <Tile className="gn-tile mt-3" style={{ borderLeft: '3px solid #0f62fe' }}>
            <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 11, color: 'var(--cds-text-secondary)' }}>MESH STATUS</div>
            ...
            {AGENTS.map(a => (
              <Tile key={a.name} className="gn-tile" style={{ borderLeft: `3px solid ${a.color}` }}>
                <div className="flex-between">
                  <div>
                    <div className="muted" style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 11, color: a.color, letterSpacing: '0.14em' }}>{a.name}</div>
                ...
                <svg viewBox="0 0 600 100" style={{ width: '100%', height: 100, marginTop: 12 }}>
                  ...
                  <text x="40" y="80" textAnchor="middle" fontFamily="IBM Plex Mono" fontSize="9" fill="#525252">root</text>
                  ...
                  <text x="500" y="50" textAnchor="middle" fontFamily="IBM Plex Mono" fontSize="9" fill={a.color} fontWeight="600">winning</text>
                </svg>
              </Tile>
            ))}
          </div>
        ...
        <Column sm={4} md={4} lg={4}>
          ...
          <Tile className="gn-tile mt-3">
            <div style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: 11, color: 'var(--cds-text-secondary)' }}>GOAL ALIGNMENT (top branch)</div>
              ...
              {[
                ...
                <div key={p.name}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.75rem' }}>
                    <span>{p.name}</span>
                    <span style={{ fontFamily: 'IBM Plex Mono, monospace' }}>{p.val.toFixed(2)}</span>
                  </div>
